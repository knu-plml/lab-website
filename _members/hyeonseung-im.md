...
- Machine learning :: deep learning for smart healthcare :: machine learning for medicine
- Program analysis and verification :: static/dynamic program analysis :: smart contract analysis and verification
- Programming language theory :: types :: modules :: syntax and semantics
- Programming languages :: functional languages :: object-oriented languages :: XML processing languages :: dynamic/script languages
- Logic in computer science :: automated theorem proving :: modal logic
- Big data analysis and processing :: database query processing :: skyline queries :: XML queries :: top-k queries
